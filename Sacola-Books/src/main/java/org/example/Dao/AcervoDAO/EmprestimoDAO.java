...
public class EmprestimoDAO {
    ...
    public void saveEmprestimo(Emprestimo emprestimo, int qtdEmprestada) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    Emprestimo emprestimo = new Emprestimo(cod_Livro, id_Usuario, dataDeEmprestimo, dataDeDevolucao, foiDevolvido);
